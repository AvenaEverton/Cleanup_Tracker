...
// import { View, Text, TextInput, TouchableOpacity, StyleSheet, Alert, Modal, TouchableWithoutFeedback, Keyboard, Image } from 'react-native';
...
//           </TouchableOpacity>
//         ) : (
//           <Image source={{ uri: images[0] }} style={styles.imagePlaceholder} />
//         )}
...
const App = () => {
  ...
  const submitReport = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.1.194:5000/api/reports', formData, {
        headers: {
