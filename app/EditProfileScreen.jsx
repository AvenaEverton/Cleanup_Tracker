...
// const avatarBorderOptions = Array(6).fill(null).map((_, index) => ({ name: `style ${index + 1}`, style: {} }));
...
//                 <View style={[styles.mainProfileIcon, avatarBorderOptions[selectedBorderIndex].style]}>
//                     {profilePicture ? (
...
//                     {profileIcons.slice(0, 6).map((icon, index) => (
//                         <TouchableOpacity
//                             key={index}
//                             style={[
//                                 styles.iconOption,
...
//                 <View style={styles.iconRow}>
//                     {profileIcons.slice(6, 12).map((icon, index) => (
//                         <TouchableOpacity
//                             key={index + 6}
//                             style={[
//                                 styles.iconOption,
//                                 selectedIconIndex === index + 6 && styles.selectedIconOption,
//                             ]}
//                             onPress={() => {
//                                 setSelectedIconIndex(index + 6);
//                                 setProfilePicture(null);
//                             }}
//                         >
//                             {icon.source ? (
