...
const MILD_BLUE = '#ADD8E6'; // Define the mild blue color
const WELCOME_TEXT_COLOR = '#FFFFFF'; // White color for visibility
const WELCOME_FONT_FAMILY = 'sans-serif-medium'; // A more modern font
...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        alignItems: "center",
        backgroundColor: MILD_BLUE, // Set the mild blue background for the container
    },
    backgroundVideo: {
        position: "absolute",
        width: width,
    ...
    welcomeText: { // New style for the welcome text
        fontSize: isTablet ? 48 : 40,
        fontWeight: "bold",
        color: WELCOME_TEXT_COLOR, // White color for visibility
        textAlign: "center",
        fontFamily: WELCOME_FONT_FAMILY, // More modern font
